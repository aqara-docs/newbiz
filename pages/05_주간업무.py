...
if existing_data:
    ...
    previous_week = st.text_area("전주업무", value=existing_data[0], height=200, key="previous_week_existing_data")
    this_week = st.text_area("금주업무", value=existing_data[1], height=200, key="this_week_existing_data")
    remarks = st.text_area("비고", value=existing_data[2], height=200, key="remarks_existing_data")
else:
    previous_week = st.text_area("전주업무", height=200, key="previous_week_new_data")
    this_week = st.text_area("금주업무", height=200, key="this_week_new_data")
